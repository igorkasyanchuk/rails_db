...
For now was tested manually only with Ruby 2.3+, and Rails 5+. But expected to work with older versions too. Also there are automated tests running on Travis CI.
