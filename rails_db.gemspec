...
Gem::Specification.new do |s|
  ...
  s.summary     = 'Inspect your Rails DB (table content viewer,
                    execute sql queries, export & import data'
  s.description = 'Quick way to inspect your Rails database,
                    see content of tables, filter, export them
                    to CSV, Excel, EXPLAIN SQL and run SQL queries.'
  s.license     = 'MIT'

  s.files = Dir['{app,config,lib,test}/**/*',
                'rails_db.gemspec',
                'Gemfile',
                'Gemfile.lock',
                'MIT-LICENSE',
  ...
  s.executables = %w[railsdb rails_db runsql]
